...
const returned = ref(props.bbook.returned);
const handleReturnBook = async () => {
    const brrBook = await borrowedBookService.update(props.bbook._id, {returnDate: Date()});
    if (brrBook) {
        returned.value = true;
    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div v-if="!props.bbook.returned" >
                    <button v-if="!props.bbook.returnDate" type="button" @click="handleReturnBook"
                    ...
                    <button v-if="props.bbook.returnDate" type="button" disabled
                        class="ml-2 mx-auto text-white bg-gradient-to-r from-gray-500 via-gray-600 to-gray-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                        Chờ xét duyệt
                    </button>
                    
                </div>
                <button v-if="props.bbook.returned" type="button" disabled
                        class="ml-2 mx-auto text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                        Trả sách thành công
                    </button>
            </div>
        </div>
